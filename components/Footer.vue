<template>
	<footer>
		<div class="container">
			<div class="content">
				<p id="copy">
					<strong> <font-awesome-icon :icon="['far', 'copyright']" flip="horizontal" /> Seth Painter - 2020</strong>
				</p>
				<ul id="other">
					<li>
			...
			<div id="external">
				...
				<nav>
					<ul>
						<li>
							<a href="https://github.com/TheFoxarmy">
								<font-awesome-icon :icon="['fab', 'github']" />
							</a>
						</li>
						<li>
							<a href="https://www.youtube.com/c/thefoxarmy11">
